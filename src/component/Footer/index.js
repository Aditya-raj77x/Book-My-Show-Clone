            ...
            <div className={styles.part3}>
                <div>
                    ...
                    <div className={styles.movies}>
                        <p className={styles.link}>Roohi</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Roberrt</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Srikaaram (Sreekaram)</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Jathi Ratnalu</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Nenjam Marappathillai</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Gaali Sampath</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Hero</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>A1 Express</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Tom &amp; Jerry</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Tiny Forest Adventure &amp; Need for Speed (7D)</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className={styles.movies}>
                        <p className={styles.link}>Tsunami</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Srikaaram (Sreekaram)</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Roohi</p>
                        ...
                        <p className={styles.link}>Jathi Ratnalu</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Romiyo Whisky</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Puaada</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Gaali Sampath</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Tandav</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Aarkkariyam</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>The Priest</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Devarakondalo Vijay Premakatha</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Roberrt</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Koli Taal</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Theethum Nandrum</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Time To Dance</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Love Life And Pakodi</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Ganesapuram</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Varthamanam</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Jeene Ki Ummeed Tumse Hi</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Kaathal Ithu Kaathal</p>
                    </div>
                </div>
                ...
                <div>
                    <div>Upcomimg Movies</div>
                    <div className={styles.movies}>
                        <p className={styles.link}>Action Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Drama Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Thriller Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Comedy Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Romantic Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Adventure Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Horror Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Fantasy Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Animation Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Crime Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Biography Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Musical Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Sci-Fi Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Mystery Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Suspense Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Period Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>screening Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>War Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Supernatural Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Adult Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Historical Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Psychological Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Noir Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Political Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Tragedy Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Mythological Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Devotional Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Bollywood Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Adaptation Movies</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Classic Movies</p>
                    </div>
                </div>
                <div>
                    <div>Upcomimg Movies</div>
                    <div className={styles.movies}>
                        <p className={styles.link}>Online Streaming Plays Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Drama Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Fantasy Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Mystery Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Noir Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Political Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Tragedy Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Suspense Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Adult Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Biography Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Action Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Historical Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Musical Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Psychological Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Sci-Fi Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Broadway Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Period Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>War Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Adventure Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Mythological Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Regional Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Horror Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Adaptation Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Classic Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Tribute Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Romantic Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Contemporary Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Comedy Plays</p>
                        <div className={styles.line}></div>
                        <p className={styles.link}>Thriller Plays</p>
                        <div className={styles.line}></div>
                    </div>
                </div>
            </div>
